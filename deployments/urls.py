...
urlpatterns = [
    ...
    path("odoo/servers/<int:server_id>/activate/", views.OdooServerActivateAPIView.as_view(), name="odoo-server-activate"),
    ...
    path("odoo/servers/<int:server_id>/metrics/", views.OdooServerMetricsAPIView.as_view(), name="odoo-server-metrics"),
    path("odoo/servers/<int:server_id>/reprovision/", views.OdooServerReprovisionAPIView.as_view(), name="odoo-server-reprovision"),
    path("odoo/servers/<int:server_id>/refresh-traefik/", views.OdooServerRefreshTraefikView.as_view(), name="odoo-server-refresh-traefik"),
    path("odoo/servers/<int:server_id>/platform-domain/", views.OdooServerPlatformDomainAPIView.as_view(), name="odoo-server-platform-domain"),
    path("odoo/servers/<int:server_id>/cancel/", views.OdooServerCancelProvisionAPIView.as_view(), name="odoo-server-cancel"),
    path("odoo/servers/<int:server_id>/docker-cleanup/", views.OdooServerDockerCleanupAPIView.as_view(), name="odoo-server-docker-cleanup"),
    path("odoo/servers/<int:server_id>/docker-cleanup/preview/", views.OdooServerDockerCleanupPreviewAPIView.as_view(), name="odoo-server-docker-cleanup-preview"),
    path("odoo/servers/<int:server_id>/docker-cleanup/execute/", views.OdooServerDockerCleanupExecuteAPIView.as_view(), name="odoo-server-docker-cleanup-execute"),
    path("odoo/servers/<int:server_id>/docker-cleanup/history/", views.OdooServerDockerCleanupHistoryAPIView.as_view(), name="odoo-server-docker-cleanup-history"),
    path("odoo/servers/<int:server_id>/docker-cleanup/export/", views.OdooServerDockerCleanupExportAPIView.as_view(), name="odoo-server-docker-cleanup-export"),
    ...
    path("odoo/instances/<int:instance_id>/repos/<int:repo_id>/pending-commits/", views.OdooInstanceRepoPendingCommitsAPIView.as_view(), name="odoo-instance-repo-pending-commits"),
    path("odoo/instances/<int:instance_id>/toggle-core-auto-update/", views.OdooInstanceToggleCoreAutoUpdateAPIView.as_view(), name="odoo-instance-toggle-core-auto-update"),
    ...
    # Odoo login relay (admin or any user)
    path("odoo/instances/<int:instance_id>/clear-admin-password/", views.OdooInstanceClearAdminPasswordAPIView.as_view(), name="odoo-instance-clear-admin-password"),
    path("odoo/instances/<int:instance_id>/admin-login/", views.OdooAdminLoginAPIView.as_view(), name="odoo-admin-login"),
    path("odoo/instances/<int:instance_id>/odoo-users/", views.OdooInstanceUsersAPIView.as_view(), name="odoo-instance-users"),
    path("odoo/instances/<int:instance_id>/login-as/", views.OdooLoginAsUserAPIView.as_view(), name="odoo-login-as-user"),
